...
public class FileEncoding {
	...
	public static void main(String[] args) throws IOException {
		...
		while (characterInFile != -1) {
			outputStream.write(characterDecryption(characterInFile, encryption));
	...
	/**
	 * Entschlüsselt ein Zeichen mit einem variablen Versatz zwischen 0 und 25
	 * 
	 ...
	 */
	static int characterDecryption(int characterInFile, int encryption) {
		int newEncryption = 26 - encryption;
		
		if (characterInFile >= 'a' && characterInFile <= 'z') {
			return (((characterInFile - 'a') + newEncryption) % lettersInAlphabet) + 'a';
